...
class Pie {
    ...
    public String toString() {
        return "pie{" + "sugar=" + sugar + ", butter=" + butter + ", eggs=" + eggs + ", vanila=" + vanilla + ", flour=" + flour + ", bakingpowder=" + bakingpowder + ", milk=" + milk + ", cherry=" + cherry + '}';
    }
...
public class BuilderPatternInterface{
    public static void main(String args[]) {
        ...
        Pie whitePie2 = new Pie.Builder().sugar(1).eggs(2).vanila(2).build();
        System.out.println(whitePie);
        System.out.println("----------------------------");
        System.out.println("2  "+whitePie2);
    }
}